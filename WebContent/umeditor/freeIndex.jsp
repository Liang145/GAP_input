...
<body>
    ...
    <p>
			<strong><span class="mathquill-embedded-latex"
				style="width: 27px; height: 42px;">\frac{a}{b}</span></strong><br />
		</p>
</script>
	...
	<div id="content">
		<p>
			<strong><span class="mathquill-embedded-latex"
				style="width: 27px; height: 42px;">\frac{a}{b}</span>&nbsp;<span
				class="mathquill-embedded-latex" style="width: 97px; height: 45px;">^1/_{\sqrt{a\int_y^x}\ln
					b}</span></strong><br />
		</p>
	</div>
